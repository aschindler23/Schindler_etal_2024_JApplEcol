...
Z_reorder <- matrix(0, nrow = nMCMC, ncol = ncol(Z))
...
# identify rows from samples matrix corresponding to each chain
...
Z_prop <- lapply(1:ncol(Z), calc_prop_Z, x = Z_reorder, K = K, n = nMCMC)
